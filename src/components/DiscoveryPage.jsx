  ...
  return (
    <div style={page(theme)}>
      <style>{`
        ...
        .call-studio-button.call-studio-active {
          animation: callStudioGlow 0.8s ease-in-out infinite;
        }
      `}</style>
      <div style={header}>
        ...
        <div style={topRow}>
          ...
          <button
            ...
            title="Call Studio"
            className={`call-studio-button${incomingCall || outgoingCall ? " call-studio-active" : ""}`}
